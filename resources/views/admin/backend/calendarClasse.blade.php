                ...
                <div class="d-flex justify-content-center gap-3">
                    @foreach ($classes as $classex)
                        @if ($classe->name == $classex->name)
                            <a class="nav-link" href={{ route('calendarClasse.showcal', $classex->id) }}> <button
            ...
            $(document).ready(function() {
                ...
                var calendar = $('#calendar').fullCalendar({
                    ...
                    eventClick: function(event) {
                        ...
                        } //i also need to check if the user_id of the clicked event is the same as the user_id of the one who clicked =>to define who has the right to click on that event
                        setTimeout(() => {
