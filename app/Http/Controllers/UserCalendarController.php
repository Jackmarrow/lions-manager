...
class UserCalendarController extends Controller
{
    ...
    public function showcal(Classe $classe)
    {
        ...
        return view("user.pages.gestion_classe.reservation_classe", compact("classe", "myevents", "classes", "userName"));
    }
    ...
    public function ajax(Request $request): JsonResponse
    {
        ...
        switch ($request->type) {
            ...
            case 'delete':
                ...
                $event = $resv_classes->where("id", $request->id)->where("user_id",auth()->user()->id)->first();
